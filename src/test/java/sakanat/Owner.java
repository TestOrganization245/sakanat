...
public class Owner {
	...
	public void iViewTheControlPanel() {
...
int e =0;
	...
	public void iAskTheOwnerToSelectTheFloorFromMenuIfHeWant() {
		/*
		if(pp==true) {
	...
	public void iAskTheOwnerIfNeedToSeeTheDetailsOfFloorHeSelected() {
	    // Write code here that turns the phrase above into concrete actions
	//    throw new io.cucumber.java.PendingException();
